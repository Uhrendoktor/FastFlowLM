...
def main(root:Path)->int:
    ...
    patch_npu_build(nb); print('PATCHED: Peano -triple fallback; Chess retained as default'); print('PATCHED: generator adapter owns 27B topology'); return 0
